...
namespace AplikasiKasirrrr {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string nama, string username, string password, string role) {
...
namespace AplikasiKasirrrr.UsersDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([nama], [username], [password], [role]) VALUES (@nama," +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [nama] = @nama, [username] = @username, [password] = @password, [role] = @role WHERE (([id] = @Original_id) AND ((@IsNull_nama = 1 AND [nama] IS NULL) OR ([nama] = @Original_nama)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)));
SELECT id, nama, username, password, role FROM Users WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nama, username, password, role FROM dbo.Users";
        ...
        public virtual int Delete(int Original_id, string Original_nama, string Original_username, string Original_password, string Original_role) {
        ...
        public virtual int Insert(string nama, string username, string password, string role) {
            if ((nama == null)) {
        ...
        public virtual int Update(string nama, string username, string password, string role, int Original_id, string Original_nama, string Original_username, string Original_password, string Original_role, int id) {
            if ((nama == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nama, string username, string password, string role, int Original_id, string Original_nama, string Original_username, string Original_password, string Original_role) {
